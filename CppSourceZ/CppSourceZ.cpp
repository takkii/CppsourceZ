...
int main(void)
{
    try
    {
		...
		// long ⇔ long equal.
        if (cpp_ver == cpp17)
            OutputDebugString(L"現在の C++ : C++17 ");
        else if (cpp_ver == cpp14)
            OutputDebugString(L"現在の C++ : C++14 ");
        else if (cpp_ver == cpp11)
            OutputDebugString(L"現在の C++ : C++11 ");
        else if (cpp_ver == cpp98)
            OutputDebugString(L"現在の C++ : C++98 ");
        else
            OutputDebugString(L"現在の C++ : pre-standard ");
